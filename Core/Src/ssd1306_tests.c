...
void MasternodeInfo(void)
{
    ...
    uint32_t end = start;
    int fps = 0;
    char message[] = "{\"name\":\"Node1\",\"Bat\":99.65,\"RSSI\":51,\"Temp\":29.35,\"Hum\":31.00,\"Prs\":305,\"ALS\":457,\"PM25\":0,\"WS\":0,\"WD\":0,\"Rain\":0} \0";
   
    ssd1306_SetCursor(2,0);
		sprintf(buff,"N:%s",APP_IPV4_HOST_ADDR);
		ssd1306_WriteString(buff, Font_6x8, White);
	
    ssd1306_SetCursor(2,10);
	  sprintf(buff,"S:%s:%d",APP_WS_SERVER_NAME,APP_WS_SERVER_PORT);
		ssd1306_WriteString(buff, Font_6x8, White);
...
void ssd1306_TestFPS() {
    ...
    ssd1306_WriteString("Jakkapan tio", Font_6x8, Black);
